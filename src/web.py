...
csv_file_tncounty = './data/Public-Dataset-County-New.csv'
csv_file_tntotal_cases = './data/Public-Dataset-Daily-Case-Info.csv'
...
dfcounty = pd.read_csv(csv_file_tncounty) 
df = load_data(csv_file_tntotal_cases)	

# Dashboard Sidebar with County list
st.sidebar.title("County-Wise Data")
County_list = st.sidebar.selectbox(
    'COUNTY',
     dfcounty.COUNTY[:8])
